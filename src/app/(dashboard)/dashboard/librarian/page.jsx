...
const LibrarianHomePage = () => {
  return (
    <div className="w-full min-h-[100vh] flex items-center justify-center p-4 md:p-6 font-urbanist text-foreground">
      {/* Main Container Layout with Left Alignment Shift */}
      <div className="max-w-2xl w-full border border-border/50 bg-gradient-to-b from-card/60 to-card/20 rounded-[32px] p-6 md:p-10 shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8">
        {/* Top librarian bookmark decoration banner */}
        <div className="absolute top-0 left-8 w-8 h-12 bg-primary/20 border-x border-b border-primary/30 rounded-b-xl flex items-end justify-center pb-1.5 text-primary">
        ...
        <div className="space-y-5 flex-1 pt-4 md:pt-0">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-muted/60 rounded-2xl border border-border flex items-center justify-center text-primary shadow-sm flex-shrink-0">
              <BookOpen size={24} className="stroke-[1.5]" />
            </div>
            <div className="space-y-0.5">
              <h1 className="text-2xl md:text-3xl font-bold font-poppins text-foreground tracking-tight">
                Hello, Librarian
              </h1>
          ...
          <div className="bg-muted/30 border border-border/40 rounded-2xl p-4 max-w-md">
