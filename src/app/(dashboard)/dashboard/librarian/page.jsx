...
const LibrarianHomePage = async () => {
  ...
  return (
    <div className="w-full min-h-[100vh] flex items-center justify-center p-4 md:p-6 font-urbanist text-foreground bg-background">
      ...
      <div className="max-w-2xl w-full border border-border/50 bg-gradient-to-b from-card/60 to-card/20 rounded-[32px] p-6 md:p-10 shadow-md relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8 backdrop-blur-md">
