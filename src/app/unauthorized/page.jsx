    ...
    <div className="min-h-[100vh] w-full flex items-center justify-center p-4 font-urbanist text-foreground relative overflow-hidden">
      ...
      <div className="max-w-md w-full border border-red-500/20 bg-gradient-to-b from-card/60 via-card/40 to-background/20 backdrop-blur-xl p-8 md:p-10 rounded-[36px] shadow-2xl text-center space-y-6 relative">
        ...
        <div className="space-y-2">
          ...
          <p className="text-base sm:text-sm text-muted-foreground/80 max-w-xs mx-auto leading-relaxed">
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3 w-full">
          ...
          <Link
            href="/"
            className="w-full sm:flex-1 inline-flex items-center justify-center gap-2 px-5 py-3.5 border border-border bg-card/40 hover:bg-muted/40 text-foreground font-poppins font-bold text-base sm:text-sm uppercase tracking-wider rounded-xl transition-all shadow-sm cursor-pointer"
          >
            <Home size={14} />
            <span>Go Home</span>
          </Link>
          ...
          <Link
            href="/signin"
            className="w-full sm:flex-1 inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-foreground text-background font-poppins font-bold text-base sm:text-sm uppercase tracking-wider rounded-xl hover:opacity-90 active:scale-[0.98] transition-all shadow-lg group cursor-pointer"
          >
            <Key size={14} />
            <span>Sign In</span>
          </Link>
