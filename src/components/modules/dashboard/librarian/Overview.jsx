...
const mostRequestedBooks = [
  { id: 1, title: "The Alchemist", author: "Paulo Coelho", requests: 45, image: "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=100" },
  { id: 2, title: "Atomic Habits", author: "James Clear", requests: 38, image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=100" },
  { id: 3, title: "Rich Dad Poor Dad", author: "Robert Kiyosaki", requests: 29, image: "https://images.unsplash.com/photo-1512820790803-83ca734da794?q=80&w=100" },
];
...
export default function LibrarianOverview() {
  ...
  return (
    <div className="space-y-8 font-urbanist text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="dashboard-card lg:col-span-2 flex flex-col justify-between">
          <div>
            <h3 className="text-xl font-bold font-poppins text-foreground">Earnings Analytics</h3>
            <p className="text-sm text-muted-foreground mb-6">Monthly revenue generation overview</p>
          </div>
          ...
          <div className="w-full h-72">
            <ResponsiveContainer width="100%" h="100%">
              <AreaChart data={analyticsData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <XAxis dataKey="name" stroke="rgb(var(--muted-foreground))" fontSize={12} tickLine={false} />
                ...
                />
                <Area type="monotone" dataKey="earnings" stroke="rgb(var(--primary))" strokeWidth={2} fillOpacity={1} fill="url(#colorPrimary)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="dashboard-card flex flex-col justify-between">
          <div>
            <h3 className="text-xl font-bold font-poppins text-foreground">Most Requested</h3>
            <p className="text-sm text-muted-foreground mb-6">Your top performing book listings</p>
          </div>
